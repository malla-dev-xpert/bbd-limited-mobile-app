                  ...
                  children: [
                    if (_options.enableLineMargin) ...[
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: DropDownCustom<MarginType>(
                              labelText: 'Type de marge',
                            ...
                            child: Column(
                              ...
                              children: [
                                buildTextField(
                                  ...
                                  label: _options.lineMarginType ==
                                          MarginType.percentage
                                      ? 'Pourcentage (%)'
                                      : 'Montant (${widget.currencySymbol})',
                                  icon: _options.lineMarginType ==
                                          MarginType.percentage
                                      ? Icons.percent
                                      : Icons.attach_money,
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        _options.lineMarginType ==
                                                MarginType.percentage
                                            ? 'Valeur en pourcentage'
                                            : 'Valeur en ${widget.currencySymbol}',
                                        style: TextStyle(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: buildTextField(
                              ...
                              label: _options.globalMarginType ==
                                      MarginType.percentage
                                  ? 'Pourcentage (%)'
                                  : 'Montant (${widget.currencySymbol})',
                              icon: _options.globalMarginType ==
                                      MarginType.percentage
                                  ? Icons.percent
                                  : Icons.attach_money,
                              keyboardType: TextInputType.number,
                  ...
                  children: [
                    if (_options.enableDiscount) ...[
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: DropDownCustom<DiscountType>(

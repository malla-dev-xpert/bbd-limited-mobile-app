...
/// Widget générique pour afficher les détails d'une entité
/// Utilisé pour CREATE et autres actions sans before/after
class GenericEntityDetailsWidget extends StatelessWidget {
  final BusinessEntityData businessData;
  final AppLocalizations localizations;

  const GenericEntityDetailsWidget({
    super.key,
  ...
  Map<String, dynamic> _filterAndSortForDisplay(Map<String, dynamic> data) {
    ...
    // Ensuite ajouter les autres champs (limité à 10)
